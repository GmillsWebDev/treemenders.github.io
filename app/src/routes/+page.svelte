...
<Hero 
    heading={`Professional tree care services`}
...
<div class="containerfull divider">
...
<style>
    ...
    .divider {
        ...
        &:has(.threePanels) {
            background: #42356C;
background: linear-gradient(90deg,rgba(66, 53, 108, 1) 0%, rgba(66, 53, 108, 1) 45%, rgba(118, 104, 134, 1) 55%, rgba(118, 104, 134, 1) 100%);
